...
Retrieval-Augmented Generation, RAG, Semantic Search, Vector Search, pgvector, PostgreSQL, FastAPI, React, TypeScript, Redis, Celery, Ollama, OpenAI APIs, Docker, Kubernetes, Authentication, Agentic AI.
